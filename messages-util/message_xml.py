...
class messageType(GeneratedsSuper):
    ...
    def __init__(self, name=None, frequency_class=None, frequency_number=None, trusted=None, compression=None, block=None, doc=None, sources=None):
        ...
        self.frequency_number = _cast(None, frequency_number)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='messageType'):
        ...
        if self.frequency_number is not None and 'frequency_number' not in already_processed:
            ...
            outfile.write(' frequency_number=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.frequency_number), input_name='frequency_number')), ))
...
class docType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='tns:', name_='docType', namespacedef_='xmlns:tns="https://leoschwarz.github.io/opensim-protocol/util/MessageSchema.xsd"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('docType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
...
class docRefType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='tns:', name_='docRefType', namespacedef_='xmlns:tns="https://leoschwarz.github.io/opensim-protocol/util/MessageSchema.xsd"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('docRefType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
