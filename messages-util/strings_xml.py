...
#
# Command line:
#   /mnt/leo/Projekte/opensim-protocol/messages-util/pyenv/bin/generateDS -o "strings_xml.py" StringsSchema.xsd
#
...
class stringsType(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, stringsType)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tns:', name_='stringsType', namespacedef_='xmlns:tns="https://leoschwarz.github.io/opensim-protocol/schema/StringsSchema.xsd"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('stringsType')
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='tns:', name_='stringsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='stringsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='stringsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from strings_xml import *\n\n')
        sys.stdout.write('import strings_xml as model_\n\n')
